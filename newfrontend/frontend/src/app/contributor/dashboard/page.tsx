...
export default function ContributorDashboardPage() {
  ...
  // "Continue working" surfaces only ACTIVE work — exclude terminal states
  // (accepted/rejected) so a done + paid task doesn't sit in the live queue.
  ...
  const supporting = activeTasks.slice(1, 4);
