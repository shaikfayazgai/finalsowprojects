...
export function Chip({
  ...
  // Defensive: an unmapped/undefined tone must never crash the page — fall back
  ...
  return (
    <span
      ...
      style={{ color: t.text, background: t.soft, borderColor: t.border }}
    >
      {dot && <span aria-hidden className="h-1.5 w-1.5 rounded-full" style={{ background: t.dot }} />}
      {children}
    </span>
  );
}
