...
import { fetchReviewerHistory, ReviewerApiError } from "@/lib/api/reviewer-api";
...
// Labels mirror the reviewer column of the delivery-status matrix.
const OUTCOME: Record<MockReviewerDecision["decision"], { label: string; tone: Tone; icon: typeof CheckCircle2 }> = {
  accept: { label: "QA accepted", tone: "success", icon: CheckCircle2 },
  rework: { label: "Returned for rework", tone: "warning", icon: RotateCcw },
