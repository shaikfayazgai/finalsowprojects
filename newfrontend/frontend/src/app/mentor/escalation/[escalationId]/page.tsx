...
import { fetchMentorEscalation, adjudicateMentorEscalation, MentorApiError } from "@/lib/api/mentor-mock";
...
export default function EscalationDetailPage() {
  ...
  const onSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      await adjudicateMentorEscalation(id, { decision: adj, reason: reason.trim(), coach });
      router.push("/mentor/escalation");
    } catch (err) {
      setLoadErr(err instanceof Error ? err.message : "Could not submit adjudication.");
      setSubmitting(false);
    }
  };
