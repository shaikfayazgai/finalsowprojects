...
> = {
  // Labels mirror the mentor column of the delivery-status matrix.
  accept: { status: "success", label: "Accepted → QA review" },
  rework: { status: "warning", label: "Returned for rework" },
