...
/**
 * Approval pipeline stages: enterprise internal gates (security → finance →
 * legal), then the enterprise Tenant-admin sign-off, then the Super admin
 * (Glimmora platform) final gate.
 */
export type SowStage = "security" | "finance" | "legal" | "tenant_admin" | "platform";
