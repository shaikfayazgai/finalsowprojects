...
export default function SowEditPage() {
  ...
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      {!editable && (
        <div className="rounded-md bg-warning-subtle border border-warning-border px-3 py-2 font-body text-[12.5px] text-warning-text">
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            ...
            <button
              ...
              className={cn(
                ...
                "disabled:bg-bg-subtle disabled:text-text-disabled disabled:opacity-100 disabled:cursor-not-allowed",
              )}
            >
