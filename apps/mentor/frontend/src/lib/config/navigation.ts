 ...
 * is a Phase 2 item — Phase 1 shows the full operational list to every
 * enterprise role; backend permission checks still gate the underlying APIs.
 *
...
export const contributorNav: ModuleConfig = {
  ...
  sections: [
    ...
    /* ─── My work — pipeline by state ─── */
    {
      title: "My work",
      items: [
        { label: "Opportunities", href: "/contributor/opportunities", icon: FileSearch },
        { label: "Delivery", href: "/contributor/delivery", icon: Send },
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Deliverables", href: "/mentor/delivery-reviews", icon: ClipboardList },
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Acceptance", href: "/enterprise/reviewer/delivery", icon: ClipboardList },
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Mentor Pools",    href: "/admin/mentors/pools",    icon: UsersRound },
    ...
    },
    {
      title: "PROGRAMS",
      items: [
        { label: "Universities",     href: "/admin/partnerships/universities",     icon: GraduationCap },
        { label: "Women Workforce",  href: "/admin/partnerships/women-workforce",  icon: HeartHandshake },
      ],
    },
  ],
};
