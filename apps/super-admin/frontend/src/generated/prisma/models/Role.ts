...
export type RoleWhereInput = {
  ...
  mutuallyExclusiveWith?: Prisma.StringNullableListFilter<"Role">
...
export type RoleOrderByWithRelationInput = {
  ...
  mutuallyExclusiveWith?: Prisma.SortOrder
...
export type RoleCreateInput = {
  ...
  scope: string
  description: string
  mutuallyExclusiveWith?: Prisma.RoleCreatemutuallyExclusiveWithInput | string[]
...
export type RoleUpdateInput = {
  ...
  mutuallyExclusiveWith?: Prisma.RoleUpdatemutuallyExclusiveWithInput | string[]
...
export type RoleCreatemutuallyExclusiveWithInput = {
  set: string[]
}

export type RoleUpdatemutuallyExclusiveWithInput = {
  set?: string[]
  push?: string | string[]
}
...
export type RoleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"code" | "scope" | "description" | "mutuallyExclusiveWith" | "createdAt" | "updatedAt", ExtArgs["result"]["role"]>
...
export interface RoleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Roles and only return the `code`
   * const roleWithCodeOnly = await prisma.role.createManyAndReturn({
   *   select: { code: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Roles and only return the `code`
   * const roleWithCodeOnly = await prisma.role.updateManyAndReturn({
   *   select: { code: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface RoleFieldRefs {
  ...
  readonly mutuallyExclusiveWith: Prisma.FieldRef<"Role", 'String[]'>
