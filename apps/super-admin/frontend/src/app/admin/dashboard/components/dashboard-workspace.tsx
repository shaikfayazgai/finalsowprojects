...
// No real superadmin dashboard aggregate endpoint exists yet. Render a clean,
// empty command center (no fabricated metrics) until one is wired up.
  ...
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        >
          {d.recent.length === 0 ? (
            <div className="rounded-xl border border-stroke-subtle px-4 py-8 text-center font-body text-[12.5px] text-text-tertiary">
