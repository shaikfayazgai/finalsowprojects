  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      >
        <Link
          href="/enterprise/sow"
          className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-text-link hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/30"
        >
      ...
      {/* Header */}
      <header className="flex items-start justify-between gap-4 flex-wrap border-b border-stroke-subtle pb-5">
        <div className="min-w-0">
          ...
          <p className="mt-1.5 font-body text-[12.5px] text-text-tertiary max-w-2xl">
            Originate a Statement of Work — upload your document and we&apos;ll
            prepare the draft for approval.
          </p>
        </div>
        <Link
          href="/enterprise/sow"
          ...
          className={cn(
            "inline-flex items-center gap-1.5 h-8 px-3 rounded-md shrink-0 shadow-xs",
