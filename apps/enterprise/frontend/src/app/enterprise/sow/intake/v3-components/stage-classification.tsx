      ...
      <section className="rounded-xl bg-surface ring-1 ring-stroke-subtle overflow-hidden">
        ...
        <div className="px-5 py-4 space-y-4">
          <div>
            ...
            <div className="inline-flex items-center gap-0.5 p-0.5 rounded-md bg-bg-subtle ring-1 ring-stroke-subtle">
              {PRIORITIES.map((p) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "inline-flex items-center h-7 px-3 rounded font-body text-[12px] font-medium",
                      "transition-colors duration-150",
                      isActive
                        ? "bg-surface text-foreground shadow-[var(--shadow-xs)] font-semibold"
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : "bg-bg-subtle text-text-secondary ring-1 ring-stroke-subtle hover:bg-[var(--state-hover)]",
                    )}
                  >
                    {f}
                  </button>
