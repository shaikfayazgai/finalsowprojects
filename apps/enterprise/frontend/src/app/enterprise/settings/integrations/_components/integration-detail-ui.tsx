...
export function BackLink() {
  return (
    <Link
      ...
      className="inline-flex items-center gap-1 font-body text-[12px] font-medium text-text-secondary hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/25 rounded-sm transition-colors duration-fast"
    >
...
export function ConfigPanel({ children }: { children: React.ReactNode }) {
  return (
    <section className="rounded-xl border border-stroke-subtle bg-surface overflow-hidden divide-y divide-stroke-subtle">
      {children}
    </section>
  );
}
...
export function ConfigSection({
  ...
  return (
    <div className="px-5 py-4">
      <div className="mb-3">
        <h2 className="font-body text-[13.5px] font-semibold text-foreground">{title}</h2>
          ...
          <button
            ...
            className={cn(
              ...
              active
                ...
                : "bg-surface border border-stroke text-text-secondary",
...
export function TextInput({
  ...
  return (
    <input
      ...
      className={cn(
        "w-full max-w-xl h-9 px-3 rounded-md border border-stroke bg-surface",
...
export function SelectInput({
  ...
  return (
    <select
      ...
      onChange={(e) => onChange(e.target.value)}
      className={cn(
        "w-full max-w-xs h-9 px-3 rounded-md border border-stroke bg-surface",
...
export function MappingList({
  ...
  return (
    <ul className="rounded-lg border border-stroke-subtle overflow-hidden divide-y divide-stroke-subtle">
      <li className="grid grid-cols-2 gap-3 px-3 py-2 border-b border-stroke-subtle">
