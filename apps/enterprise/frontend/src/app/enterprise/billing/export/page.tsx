...
function RadioRow<T extends string>({
  ...
  return (
    <label className="flex items-center gap-2 px-2 py-1 rounded hover:bg-bg-subtle transition-colors duration-fast cursor-pointer">
      <input
        type="radio"
...
function CheckRow({
  ...
  return (
    <label
      className={cn(
        "flex items-center gap-2 px-2 py-1 rounded transition-colors duration-fast",
        disabled ? "opacity-50 cursor-not-allowed" : "hover:bg-bg-subtle cursor-pointer",
      )}
    >
      <input
        type="checkbox"
