      ...
      <section className="rounded-xl border border-stroke-subtle bg-surface overflow-hidden">
        <div className="px-5 pt-4 pb-4 border-b border-stroke-subtle">
          ...
          <p className="mt-1 font-body text-[12.5px] text-text-secondary">
            Two baseline views — drill into skills, throughput, spend, and ROI.
          </p>
        </div>
  ...
  return (
    <li>
      <Link
        href={href}
        className={cn(
          "flex flex-col lg:flex-row lg:items-center gap-4 px-5 py-4 min-h-[88px]",
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="flex flex-wrap items-center gap-x-2 gap-y-0.5">
            ...
            <span className="inline-flex items-center gap-1 font-body text-[11.5px] font-semibold text-text-link">
              Open
