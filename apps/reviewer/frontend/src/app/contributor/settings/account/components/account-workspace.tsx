...
function MfaPanel() {
  // Persisted MFA preference (survives reloads).
  const mfaOn = useContributorSettingsStore((s) => s.mfaEnabled);
  const setMfaOn = useContributorSettingsStore((s) => s.setMfaEnabled);
