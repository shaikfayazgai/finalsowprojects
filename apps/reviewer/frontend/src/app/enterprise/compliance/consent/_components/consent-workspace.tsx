    ...
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      <section className="rounded-xl border border-stroke-subtle bg-surface overflow-hidden">
                ...
                >
                  ...
                  <span
                    className={cn(
                      ...
                      tab.key === "missing" && count > 0 && !active && "text-error-text font-semibold",
                    )}
                  >
                    {isLoading ? "—" : count}
                  </span>
        ...
        {isLoading && !data ? (
          ...
          <>
            <div className="hidden md:grid md:grid-cols-[1.4fr_repeat(7,minmax(0,0.55fr))_0.75fr] gap-2 px-5 py-2 bg-bg-subtle/50 border-b border-stroke-subtle font-body text-[10px] font-bold uppercase tracking-[0.08em] text-text-tertiary">
        ...
        <div className="px-5 py-3 border-t border-stroke-subtle bg-bg-subtle/30">
  ...
  return (
    <li
      className={cn(
        ...
        !row.isComplete && "bg-warning-subtle/10",
      )}
    >
...
function StatusPill({ complete }: { complete: boolean }) {
  return (
    <span
      className={cn(
        "inline-flex px-2 py-0.5 rounded-full font-body text-[10px] font-semibold shrink-0",
        complete ? "bg-success-subtle text-success-text" : "bg-error-subtle text-error-text",
      )}
    >
