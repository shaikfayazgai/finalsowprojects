...
const ROLES = [
  {
    ...
    desc: "AI-powered SOW decomposition, smart team formation, and real-time outcome monitoring â€” all in one platform.",
...
export default function HomePage() {
  ...
  // Authenticated users should never see the marketing page â€” send them
    ...
    <MeshBackground variant="warm" className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {isLoggedIn ? (
              ...
              <>
                <Link href="/contributor/login" className="hidden sm:block text-sm font-medium text-beige-600 hover:text-brown-900 transition-colors">
                  Sign In
                </Link>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="text-lg text-beige-600 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          From SOW to delivery â€” intelligent, transparent, and outcome-based.
        </p>
      ...
      {/* â”€â”€ Features Edge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {/* â”€â”€ Role Cards â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section id="roles" className="scroll-mt-24 max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-beige-600 max-w-xl mx-auto">
            One platform, three powerful portals â€” each tailored to how you work.
          </p>
        </div>
      ...
      <section id="how-it-works" className="max-w-6xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-br from-brown-950 to-brown-800 rounded-3xl p-10 md:p-14 text-center text-white">
          ...
          <p className="text-brown-200 max-w-xl mx-auto mb-10 text-sm leading-relaxed">
            GlimmoraTeam's AI engine decomposes your SOW, assembles the right team, monitors delivery, and ensures quality â€” end to end.
          </p>
      ...
      <footer className="border-t border-beige-200 bg-white/80 pt-16 pb-8">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="pt-8 border-t border-beige-200 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-beige-500">
            <p>Â© 2026 Glimmora International. All rights reserved.</p>
