            ...
            <>
              <DashboardSection bare title="Platform health" description="Last 30 days · demo metrics">
                <dl className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-8 gap-y-4">
                  ...
                  />
                  <SummaryStat label="SOWs in flight" value={String(tenant.sows)} />
                ...
                <section className="rounded-xl border border-stroke-subtle bg-surface overflow-hidden">
                  <header className="px-5 pt-4 pb-3 border-b border-stroke-subtle flex flex-wrap items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="mt-1 font-body text-[12.5px] text-text-secondary">
                        A random temporary password was emailed to {inviteName} ({inviteEmail}).
                        They sign in at{" "}
                        <code className="font-mono text-[11px]">/enterprise/login</code> and are
                        forced to set a new password on first sign-in.
                      </p>
                    </div>
                    <span className="inline-flex items-center gap-1 rounded-full bg-success-subtle text-success-text px-2 py-0.5 font-body text-[10.5px] font-semibold">
                  ...
                  <div className="px-5 py-4 space-y-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <button
                        type="button"
                        onClick={resendPrimaryAdmin}
                        disabled={resending}
                        className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md bg-brand text-on-brand font-body text-[12px] font-semibold hover:bg-brand-hover transition-colors duration-fast disabled:opacity-50 disabled:cursor-not-allowed"
                      >
