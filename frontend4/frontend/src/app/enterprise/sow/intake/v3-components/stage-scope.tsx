          ...
          <Field label="Attachments" hint="PDF, DOCX up to 25 MB each">
            <div
              ...
              className={cn(
                ...
                isDragging
                  ? "ring-2 ring-[var(--color-brand)] bg-[color-mix(in_oklab,var(--color-brand)_5%,transparent)]"
                  : "ring-stroke-subtle bg-bg-subtle/50",
              )}
            >
              <FileUp
                className={cn(
                  "h-5 w-5 transition-colors duration-150",
                  isDragging ? "text-[var(--color-brand)]" : "text-text-tertiary",
                )}
                strokeWidth={2}
                aria-hidden
              />
              ...
              <button
                ...
                className={cn(
                  ...
                  "hover:bg-[var(--state-hover)] transition-colors duration-150",
                )}
              >
            ...
            {attachments.length > 0 && (
              <ul className="mt-2 space-y-1.5">
                {attachments.map((f, idx) => (
                  <li
                    key={idx}
                    className="flex items-center gap-2 rounded-lg bg-bg-subtle/50 ring-1 ring-stroke-subtle px-3 py-2 font-body text-[12px]"
                  >
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center h-6 w-6 rounded-md text-text-tertiary hover:bg-[var(--state-hover)] hover:text-foreground transition-colors duration-150"
                    >
...
const inputCls = cn(
  ...
  "font-body text-[12.5px] text-foreground placeholder:text-text-tertiary",
