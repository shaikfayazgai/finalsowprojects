...
export function SsoWorkspace() {
  ...
  const onTestLogin = () => {
    toast.info("Test login started", "Opening the IdP sign-in flow in a new window.");
  };
      ...
      <ConfigPanel>
          ...
          <div className="space-y-4 max-w-xl">
            ...
            <div>
              ...
              <button
                ...
                className="mt-2 inline-flex items-center gap-1 font-body text-[12px] font-semibold text-brand hover:opacity-80"
              >
        ...
        <ConfigSection title="Testing" hint="Verify claims before enforcing SSO">
          <button
            type="button"
            onClick={onTestLogin}
            className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md border border-stroke bg-surface font-body text-[12px] font-semibold text-foreground"
          >
