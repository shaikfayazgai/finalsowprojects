      ...
      <section className={cn(GLASS_CARD, "overflow-hidden")} style={GLASS_SHADOW}>
        <div className="px-5 pt-4 pb-0 border-b border-white/55">
          <div className="flex flex-wrap items-center gap-3 pb-4">
            ...
            <div className="relative w-full sm:w-56 order-last sm:order-none sm:ml-auto">
              ...
              <input
                ...
                className={cn(
                  "w-full h-9 pl-8 pr-8 rounded-xl backdrop-blur-md",
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                className={cn(
                  ...
                  "border border-white/70 bg-white/55 backdrop-blur text-foreground",
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pb-3">
            ...
            <div
              ...
              className="inline-flex items-center gap-0.5 p-1 rounded-xl bg-white/45 border border-white/70 backdrop-blur"
            >
              {TIME_PRESETS.map((p) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "h-7 px-2.5 rounded-lg font-body text-[11.5px] font-semibold transition-colors duration-fast",
                      active ? "text-white" : "text-text-secondary hover:text-foreground hover:bg-white/60",
                    )}
              ...
              {activeChips.map((chip) => (
                <button
                  ...
                  className={cn(
                    ...
                    "bg-white/65 border border-white/70 backdrop-blur",
                    "font-body text-[11.5px] font-medium text-foreground",
                    "hover:bg-white/85 transition-colors duration-fast",
                  )}
                >
                  {chip.label}
          ...
          <div className="pb-3 border-t border-white/55 pt-3">
            <button
              type="button"
              onClick={() => setFiltersOpen((o) => !o)}
              aria-expanded={filtersOpen}
              className={cn(
                "inline-flex items-center gap-1.5 font-body text-[12px] font-semibold transition-colors duration-fast",
        ...
        {isLoading && !data ? (
          ...
          <>
            ...
            <footer className="flex flex-wrap items-center justify-between gap-3 px-5 py-3 border-t border-white/55">
...
function ContextBanner({
  ...
  return (
    <div
      ...
      style={{
        background: tone === "error" ? TONE.error.soft : TONE.warning.soft,
        borderColor: tone === "error" ? TONE.error.border : TONE.warning.border,
      }}
    >
      <p
...
const filterInputCls = cn(
  "w-full h-9 px-2.5 rounded-xl backdrop-blur-md",
  "font-mono text-[12px] text-foreground placeholder:text-text-disabled",
  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(124,92,246,0.32)]",
);

const applyBtnCls = cn(primaryBtnClass, "h-9 px-3.5 text-[12px]");

const secondaryBtnCls = cn(ghostBtnClass, "h-9 px-3.5 text-[12px]");
