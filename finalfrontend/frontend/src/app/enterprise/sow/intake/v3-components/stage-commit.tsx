...
export const StageCommit: React.FC<StageCommitProps> = ({
  ...
  <section className={cn(GLASS_CARD, "overflow-hidden")} style={GLASS_SHADOW}>
    ...
    <footer className="px-5 py-3.5 border-t border-white/55 bg-[var(--color-ai-surface)] flex items-center gap-3 flex-wrap">
...
const Row: React.FC<{
  ...
  <div className="flex items-start gap-3 rounded-xl bg-white/45 ring-1 ring-white/55 backdrop-blur px-3 py-2.5">
    <span
      className={cn(
