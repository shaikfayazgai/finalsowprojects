      ...
      <section className={cn(GLASS_CARD, "overflow-hidden")} style={GLASS_SHADOW}>
        ...
        <div className="px-5 py-4 space-y-4">
          <div>
            ...
            <div className="inline-flex items-center gap-0.5 p-1 rounded-xl bg-white/45 ring-1 ring-white/70 backdrop-blur">
              {PRIORITIES.map((p) => {
              ...
              {REVIEW_MODELS.map((m) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "text-left rounded-xl px-3 py-2.5 backdrop-blur",
                      ...
                      isActive
                        ...
                        : "ring-1 ring-white/70 bg-white/45 hover:bg-white/60",
                    )}
                  >
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      "font-body text-[11.5px] font-semibold backdrop-blur",
                      "transition-colors duration-150",
                      isActive
                        ? "text-white"
                        : "bg-white/55 text-text-secondary ring-1 ring-white/70 hover:bg-white/75",
                    )}
