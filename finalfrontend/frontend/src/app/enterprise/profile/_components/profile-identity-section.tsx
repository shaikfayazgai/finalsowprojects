      ...
      {tenantSettingsAccess !== "none" && (
        <div className="mt-4 pt-4 border-t border-white/55">
          <Link
            ...
            className="flex items-center justify-between gap-3 rounded-lg border border-white/55 bg-white/40 hover:bg-white/50 transition-colors duration-fast px-4 py-3 min-h-[52px]"
          >
