...
import { GLASS_FIELD_STYLE, primaryBtnClass, primaryStyle, ghostBtnClass, SectionCard, Chip } from "@/app/admin/_shell/aurora-ui";
...
export default function InvoiceDetailPage() {
  ...
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      <SectionCard title="Invoice details" description="Project and billing period">
          ...
          invoice.lineItems.length > 3 ? (
            <div className="relative w-44">
              ...
              <input
                ...
                className="w-full h-8 pl-9 pr-2 rounded-xl backdrop-blur-md font-body text-[12px] text-foreground placeholder:text-text-disabled focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(124,92,246,0.32)]"
              />
            </div>
          ) : undefined
        }
      ...
      <SectionCard title="Totals" description="Amount due for this period">
        <div className="px-5 sm:px-6 py-5">
...
function StubAction({
  ...
  return (
    <button
      ...
      disabled
      title="Phase 2"
      className={cn(ghostBtnClass, "h-8 px-2.5 text-[12px] opacity-60 cursor-not-allowed")}
    >
      {icon}
      {children}
    </button>
