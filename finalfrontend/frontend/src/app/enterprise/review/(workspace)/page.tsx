          ...
          <div className="flex flex-wrap items-start justify-between gap-3 pb-4">
            <div className="min-w-0">
              ...
              <Link
                ...
                className="mt-2 inline-block font-body text-[12px] font-medium text-text-secondary hover:text-foreground transition-colors duration-fast"
              >
                Decision history
              </Link>
            </div>
    ...
    <div className="px-5 py-14 text-center">
      {isEmptyTenant ? (
        <>
          ...
          <Link
            href="/enterprise/review/history"
            className="mt-4 inline-block font-body text-[12.5px] font-semibold text-text-secondary hover:text-foreground"
          >
