...
export function QaDecisionPanel({
  ...
  return (
    <div className="space-y-4">
      ...
      {review.round >= 2 && (
        <p className="font-body text-[12px] text-text-secondary rounded-xl border border-white/55 bg-white/45 backdrop-blur px-3 py-2">
      ...
      <div className="flex flex-wrap items-center justify-end gap-2 pt-1">
        <Link href="/enterprise/reviewer" className={ghostBtnClass}>
          Cancel
        </Link>
        <button
          type="button"
