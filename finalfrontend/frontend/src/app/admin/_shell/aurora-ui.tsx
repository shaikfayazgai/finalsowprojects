...
export function SectionCard({
  ...
  return (
    <GlassCard className={cn("overflow-hidden", className)}>
      {(title || action) && (
        <header className="px-5 sm:px-6 pt-4 pb-3.5 border-b border-white/55 flex flex-wrap items-start justify-between gap-3">
...
export const FIELD_SURFACE = cn(
  "border border-[rgba(26,22,68,0.14)] bg-white/80 backdrop-blur",
  "shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_1px_2px_rgba(26,22,68,0.05)]",
...
/**
 * Glassmorphism stroke for interactive form controls. A translucent fill over
 * the blurred backdrop with a light-catching gradient *rim* — bright white at
 * the top-left, a violet sheen through the middle, fading to a faint ink edge.
 * Reads as a refractive glass edge rather than a flat hairline, and stays
 * legible on top of a glass card. Apply as an inline `style` (the two-layer
 * background-clip can't be expressed as a utility class).
 */
export const GLASS_FIELD_STYLE: React.CSSProperties = {
  border: "1.5px solid transparent",
  backgroundImage:
    "linear-gradient(rgba(255,255,255,0.72), rgba(255,255,255,0.72)), linear-gradient(140deg, rgba(150,128,255,0.45) 0%, rgba(150,128,255,0.5) 44%, rgba(26,22,68,0.16) 100%)",
  backgroundOrigin: "border-box",
  backgroundClip: "padding-box, border-box",
  WebkitBackgroundClip: "padding-box, border-box",
  boxShadow: "inset 0 1px 0 rgba(255,255,255,0.7), 0 2px 6px -2px rgba(26,22,68,0.10)",
};
...
/** Layout + focus only — the visible glass surface comes from GLASS_FIELD_STYLE. */
export const GLASS_FIELD_CLASS =
  "backdrop-blur-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(124,92,246,0.32)]";
