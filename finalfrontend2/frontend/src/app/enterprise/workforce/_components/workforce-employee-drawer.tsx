...
import { Chip, ghostBtnClass } from "@/app/admin/_shell/aurora-ui";
    ...
    <Drawer
      ...
      footer={
        <div className="flex items-center justify-end gap-2 w-full">
          ...
          <Link href="/enterprise/projects" className={ghostBtnClass}>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 flex flex-wrap gap-1.5">
              ...
              <Chip tone={member.status === "inactive" ? "neutral" : "success"} dot={false}>
              ...
              {member.primarySkills.length > 0 ? (
                <ul className="flex flex-wrap gap-1.5">
                  {member.primarySkills.map((skill) => (
                    <li
                      key={skill}
                      className="inline-flex px-2 py-0.5 rounded-md border border-white/55 bg-white/45 backdrop-blur font-body text-[11.5px] text-foreground"
                    >
                      {skill}
                    </li>
                  ))}
