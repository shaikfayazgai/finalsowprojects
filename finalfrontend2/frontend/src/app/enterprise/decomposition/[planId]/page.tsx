...
import { getProjectByPlanMock } from "@/lib/projects/projects-mock";
...
function PlanDetailView({
  ...
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      <SectionCard title="Plan details" description="Metadata for this decomposition plan">
...
function MilestoneGroup({
  ...
  return (
    <div className="border-t border-white/55 first:border-t-0 first:pt-0 pt-4 first:mt-0">
...
function TaskRow({ task }: { task: TaskDetail }) {
  ...
  return (
    <li className="flex items-center justify-between gap-4 px-5 sm:px-6 py-2.5 min-h-[44px] hover:bg-white/50 transition-colors duration-fast">
      <div className="min-w-0 flex items-center gap-2">
        ...
        {task.requiredSkills.length === 0 && (
          <span
            className="inline-flex items-center gap-1 px-1.5 py-0 rounded border border-white/55 font-body text-[10px] font-semibold shrink-0 backdrop-blur"
  ...
  return (
    <>
      {critical.pathIds.length > 0 && (
        <div className="mb-4 pb-4 border-b border-white/55">
          ...
          {dependencies.map((d) => {
            ...
            return (
              <li
                key={d.id}
                className={cn(
                  "px-5 sm:px-6 py-2.5 flex items-center gap-2 font-body text-[12.5px] min-h-[44px] hover:bg-white/50 transition-colors duration-fast",
