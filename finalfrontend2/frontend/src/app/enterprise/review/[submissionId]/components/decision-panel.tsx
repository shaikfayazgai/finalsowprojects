  ...
  if (readOnly && decided) {
    ...
    return (
      <div className="space-y-3">
        <div
          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-white/70 bg-white/65 backdrop-blur font-body text-[12px] font-semibold"
        ...
        {decided.note ? (
          <p className="font-body text-[13px] text-foreground leading-relaxed rounded-xl border border-white/55 bg-white/45 px-3 py-2.5 backdrop-blur">
            {decided.note}
          </p>
        ) : null}
        {accepted ? (
  ...
  return (
    <div className="space-y-4">
      {!item.enterpriseReviewerId && (
        <div className="rounded-xl border border-white/55 bg-white/45 backdrop-blur px-3 py-2.5 flex flex-wrap items-center justify-between gap-3">
