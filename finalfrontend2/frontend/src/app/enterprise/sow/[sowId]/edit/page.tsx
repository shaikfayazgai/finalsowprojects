...
import { SectionCard, primaryBtnClass, primaryStyle, ghostBtnClass, GLASS_FIELD_STYLE } from "@/app/admin/_shell/aurora-ui";
...
export default function SowEditPage() {
  ...
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      {!editable && (
        <div className="rounded-2xl bg-warning-subtle border border-warning-border backdrop-blur px-3 py-2 font-body text-[12.5px] text-warning-text">
