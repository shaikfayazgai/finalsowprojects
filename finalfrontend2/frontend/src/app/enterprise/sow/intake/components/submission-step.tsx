  ...
  return (
    <section className={cn(GLASS_CARD, "overflow-hidden")} style={GLASS_SHADOW}>
      ...
      <div className="px-5 sm:px-6 py-5 space-y-5">
        <div className="rounded-xl border border-white/55 bg-white/50 backdrop-blur px-3 py-2 flex items-center gap-2">
        ...
        <div>
          ...
          <ol className="space-y-2">
            {APPROVAL_STAGE_ORDER.map((stage, i) => (
              <li
                key={stage}
                className="flex items-start gap-3 rounded-xl border border-white/55 bg-white/55 backdrop-blur px-3 py-2.5 transition-colors duration-fast hover:bg-white/70"
              >
                <span
        ...
        <label className="flex items-start gap-2.5 cursor-pointer group">
          <input
            ...
            className="mt-0.5 h-4 w-4 rounded border-white/70 text-brand focus-visible:ring-2 focus-visible:ring-[rgba(124,92,246,0.32)]"
          />
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 rounded-xl resize-y backdrop-blur-md font-body text-[13px] text-foreground placeholder:text-text-disabled focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(124,92,246,0.32)]"
          />
        </div>
      </div>

      <footer className="px-5 sm:px-6 py-3.5 border-t border-white/55 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={onCancel}
            className="inline-flex items-center justify-center h-10 px-3.5 rounded-2xl font-body text-[13.5px] font-semibold text-text-tertiary hover:text-foreground transition-colors duration-fast"
          >
            Cancel
          </button>
        </div>
