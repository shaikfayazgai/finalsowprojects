...
export function PricingSection({ value, onChange }: Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="inline-flex rounded-xl border border-white/70 bg-white/45 backdrop-blur p-1" role="tablist" aria-label="Pricing mode">
        <ModeButton
          active={mode === "manual"}
      ...
      <div className="rounded-xl border border-white/55 bg-white/50 backdrop-blur px-3 py-2.5">
    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-9 pl-6 pr-3 rounded-xl backdrop-blur-md font-body text-[13px] text-foreground placeholder:text-text-disabled focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(124,92,246,0.32)]"
        />
      </div>
