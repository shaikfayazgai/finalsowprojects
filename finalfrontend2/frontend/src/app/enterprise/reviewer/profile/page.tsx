...
// MOCK_REVIEWER_PROFILE removed — using live session data
  ...
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      <div className={cn(GLASS_CARD, "overflow-hidden")} style={GLASS_SHADOW}>
        <div className="px-5 py-4 flex items-center gap-4 border-b border-white/55">
          <span
            aria-hidden
            className="inline-flex h-12 w-12 items-center justify-center rounded-xl text-white font-body text-[14px] font-bold"
        ...
        <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 px-5 py-4">
          ...
          <div>
            ...
            <dd className="mt-1 font-body text-[13px] text-foreground">Glimmora HQ</dd>
          </div>
          <div>
            <dt className="font-body text-[10.5px] font-bold uppercase tracking-[0.1em] text-text-tertiary">
              Member since
