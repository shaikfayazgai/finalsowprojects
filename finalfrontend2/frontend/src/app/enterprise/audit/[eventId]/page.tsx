          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 font-body text-[12px] text-text-secondary">
                ...
                <Link href="/enterprise/audit/export" className="text-text-secondary font-medium hover:text-foreground hover:underline">
                  Export audit
                </Link>{" "}
    ...
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      {(newer || older) && (
        <nav
          ...
          className={cn(GLASS_CARD, "flex items-center justify-between gap-3 px-2 py-1.5")}
          style={GLASS_SHADOW}
        >
          {older ? (
      ...
      <header>
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            <h1 className="text-[22px] font-semibold text-foreground tracking-[-0.015em] leading-tight font-mono break-all">
              {event.action}
            </h1>
      ...
      <SectionCard title="Summary" description="What happened">
      ...
      <SectionCard title="Actor & resource" description="Who, what, and where">
        ...
        <div className="px-5 pt-4 pb-0 border-b border-white/55">
          <div className="flex flex-wrap items-start justify-between gap-3 pb-3">
            ...
            <Link
              ...
              className={cn(ghostBtnClass, "h-9 px-3 text-[12px] shrink-0")}
            >
              ...
              {(
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "relative px-3 py-2.5 font-body text-[13px] font-medium transition-colors duration-fast",
      ...
      <SectionCard title="Technical identifiers" description="For export and correlation">
        <div className="px-5 py-5">
...
const headerBtnCls = cn(ghostBtnClass, "h-9 px-3 text-[12.5px]");
