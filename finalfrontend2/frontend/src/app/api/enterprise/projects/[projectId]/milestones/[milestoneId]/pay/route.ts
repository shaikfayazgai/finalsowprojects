/**
 * Proxy: POST /api/enterprise/projects/[projectId]/milestones/[milestoneId]/pay
 *
 * Forwards to POST /api/v1/projects/{projectId}/milestones/{milestoneId}/pay
...
export async function POST(
  ...
  const upstream = `${GLIMMORA_API}/api/v1/projects/${encodeURIComponent(projectId)}/milestones/${encodeURIComponent(milestoneId)}/pay`;
  ...
  try {
    ...
    console.error("[api/enterprise/projects/milestones/pay POST]", err);
