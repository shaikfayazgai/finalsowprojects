/**
 *   PATCH /api/mentor/settings/notifications
 *
 ...
 *   The notification rows payload is forwarded wrapped under settings.notifications.
 */
...
export async function PATCH(req: NextRequest) {
  // Wrap the notifications payload into the { settings: {...} } shape the backend expects.
  ...
  const wrapped = JSON.stringify({ settings: { notifications: raw } });
