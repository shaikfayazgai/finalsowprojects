/**
 * Proxy: GET /api/reviewer/history
 * Forwards to reviewer backend GET /api/v1/reviewer/history
 * Returns { items: MockReviewerDecision[], total: number, metrics: ReviewerMetrics }
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    const res = await fetch(`${GLIMMORA_API}/api/v1/reviewer/history`, {
      headers: {
    ...
    console.error("[api/reviewer/history GET]", err);
