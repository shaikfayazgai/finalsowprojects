...
import { GraduationCap, Loader2, Plus, Search, UserRound, X } from "lucide-react";
import { useAdminMentorsListFull } from "@/lib/hooks/use-admin-mentors";
...
export function MentorsWorkspace() {
  ...
  const { mentors, loading: isLoading, error: fetchError } = useAdminMentorsListFull();
  ...
  return (
    <div className="space-y-5 pb-4 animate-fade-in">
      ...
      <NewMentorModal open={inviteOpen} onClose={() => setInviteOpen(false)} />
