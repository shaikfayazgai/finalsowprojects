...
export function DashboardSkeleton() {
  return (
    <div className="space-y-5 pb-4 animate-fade-in">
      ...
      <div className="rounded-2xl border border-stroke-subtle bg-surface overflow-hidden">
...
export function ReviewerMetricsSkeleton() {
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="rounded-xl border border-stroke-subtle bg-surface p-5 space-y-3">
...
export function ProfileSkeleton() {
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      {Array.from({ length: 5 }).map((_, i) => (
        <div key={i} className="rounded-xl border border-stroke-subtle bg-surface overflow-hidden p-5">
...
export function IntegrationDetailSkeleton() {
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      <div className="rounded-xl border border-stroke-subtle bg-surface overflow-hidden divide-y divide-stroke-subtle">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="px-5 py-4 space-y-3">
            <Skeleton className="h-4 w-32" />
