        ...
        <div className="space-y-5">
          ...
          <div className="pt-2 border-t border-beige-100 space-y-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-xs font-semibold text-brown-700 uppercase tracking-wide">Documents & Tax ID</p>
                ...
                >
                  ...
                  {incorporationFile ? (
                    ...
                    <>
                      ...
                      <div>
                        <p className="text-sm text-brown-700 font-medium">Drop or browse</p>
                        <p className="text-[10px] text-beige-400 mt-0.5">PDF, JPG, PNG — max 10 MB</p>
                      </div>
                    </>
                  )}
                </label>
