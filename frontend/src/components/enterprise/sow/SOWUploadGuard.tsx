...
export function SOWUploadGuard() {
  ...
  // The multi-step upload wizard was removed (upload now lands straight on the
  // SOW detail), so there's nothing in-progress to guard. Disabled to stop the
  // stale "Step 7 of 7 — leave this page?" modal from firing.
