...
export function CommercialReviewWorkspace() {
  ...
  const runDecision = async (action: CommercialDecisionAction, payload: CommercialDecisionPayload) => {
    ...
    try {
      ...
      if (action === "approve") {
        await approveSow(sowId, "commercial", `${payload.comment}${suffix}`);
  ...
  return (
    <div className="space-y-5 pb-12 animate-fade-in">
      ...
      <header className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          <p className="font-body text-[10.5px] font-bold uppercase tracking-[0.14em] text-text-tertiary mb-1.5">
            Commercial gate · Stage 2 of 5 · v{sow.activeVersion}
          </p>
      ...
      >
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 font-body text-[11.5px] text-text-secondary leading-relaxed">
            Submitted {timeAgo(sow.submittedForApprovalAt)} · Business stage signed off · advances
      ...
      <DashboardSection
        ...
        description="Business → Commercial → Legal → Security → Final"
      >
