...
export interface MockTenant {
  id: string;
  name: string;
  /** Unique human-readable company code (e.g. ACME-7K2). */
  companyCode?: string;
  domain: string;
...
export const MOCK_PROVISIONING_STEPS: Record<string, ProvisioningStep[]> = {
  "t-acme": [
    ...
    { id: "employees", label: "Employee import (manual)",                  state: "done", at: "2026-01-20T14:00:00Z" },
  ],
  "t-reporting": [
    ...
    { id: "employees", label: "Employee import (manual)",                  state: "pending" },
  ],
  "t-kestrel": [
