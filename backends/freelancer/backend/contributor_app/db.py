...
ALTER TABLE contributor_projects ADD COLUMN IF NOT EXISTS video TEXT;
ALTER TABLE contributor_projects ADD COLUMN IF NOT EXISTS screenshots TEXT[] DEFAULT '{}';
