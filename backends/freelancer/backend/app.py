...
def _startup() -> None:
    try:
        ...
        # The submissions/artifacts tables back the delivery → review flow; ensure
        # them explicitly (their DDL isn't covered by init_contributor_schema).
        submissions_router.ensure_submissions_schema()
